...
print("Введите расстояния в километрах для каждого сотрудника (через пробел):")
distances = list(map(int, input().split()))
print("Введите тарифы в рублях за проезд одного километра для каждой машины (через пробел):")
